...
func TestInteractionHandler_ModalSubmit_Success(t *testing.T) {
	pub, priv := testKeyPair(t)
	created := fakeTask()
	handler := InteractionHandler(pub, nil, fakeCreateTask(created, nil), nil, nil, nil)
...
func TestInteractionHandler_ModalSubmit_CreatorError(t *testing.T) {
	pub, priv := testKeyPair(t)
	handler := InteractionHandler(pub, nil, fakeCreateTask(nil, fmt.Errorf("db connection refused")), nil, nil, nil)
...
func TestInteractionHandler_ModalSubmit_WithHarnessAndBudget(t *testing.T) {
	...
	handler := InteractionHandler(pub, nil, creator, nil, nil, nil)
