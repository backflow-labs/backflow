...
ALLOWLIST=(
    ...
    BACKFLOW_MAX_USER_RETRIES BACKFLOW_POLL_INTERVAL_SEC
    ...
    BACKFLOW_ECS_LAUNCH_TYPE BACKFLOW_ECS_CONTAINER_NAME
    BACKFLOW_ECS_LOG_STREAM_PREFIX BACKFLOW_ECS_ASSIGN_PUBLIC_IP
    BACKFLOW_CLOUDWATCH_LOG_GROUP BACKFLOW_MAX_CONCURRENT_TASKS

    # Discord
    BACKFLOW_DISCORD_APP_ID BACKFLOW_DISCORD_PUBLIC_KEY BACKFLOW_DISCORD_BOT_TOKEN
    BACKFLOW_DISCORD_GUILD_ID BACKFLOW_DISCORD_CHANNEL_ID
    BACKFLOW_DISCORD_ALLOWED_ROLES BACKFLOW_DISCORD_COMMAND_NAME BACKFLOW_DISCORD_EVENTS

    # SMS / Twilio
    BACKFLOW_SMS_PROVIDER TWILIO_ACCOUNT_SID TWILIO_AUTH_TOKEN
    BACKFLOW_SMS_FROM_NUMBER BACKFLOW_SMS_EVENTS BACKFLOW_SMS_OUTBOUND_ENABLED
